...
- [15. Примеры из PDF](#15-примеры-из-pdf)
...
### 15.2. Пример ответа `GET /game-tags`
...
### 15.3. Пример ответа `GET /games/lobby`
...
### 15.4. Пример ответа `POST /games/init`
...
### 15.5. Пример ответа на `action=balance`
...
### 15.6. Пример ответа на `action=bet`
...
### 15.7. Пример ответа на `action=win`
...
### 15.8. Пример ответа на `action=refund`
...
### 15.9. Пример ответа на `action=rollback`
...
### 15.10. Пример ответа `GET /limits`
...
### 15.11. Пример ответа `GET /limits/freespin`
...
### 15.12. Пример ответа `GET /jackpots`
...
### 15.13. Пример ответа `GET /freespins/bets`
...
### 15.14. Пример ответа `GET /freespins/get`
...
### 15.15. Пример ответа `GET /freevouchers/get`
